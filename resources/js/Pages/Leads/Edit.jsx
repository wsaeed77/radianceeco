...
export default function EditLead({ lead, sources, stages, statuses, agents }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        grant_type: lead.grant_type || '',
        funders: lead.funders || '',
        notes: lead.notes || '',
        agent_id: lead.agent_id || '',
        // Data Match fields
        benefit_holder_name: lead.benefit_holder_name || '',
        benefit_holder_dob: lead.benefit_holder_dob || '',
        data_match_status: lead.data_match_status || '',
        data_match_remarks: lead.data_match_remarks || '',
        multi_phone_labels: [],
        multi_phone_numbers: [],
        // Eligibility fields
        occupancy_type: lead.occupancy_type || '',
        eligibility_client_dob: lead.eligibility_client_dob || '',
        ...
        epc_details: lead.epc_details || '',
        // Additional Information
        epr_report: lead.epr_report || '',
        // EPR Fields
    ...
    const [phoneFields, setPhoneFields] = useState(
        lead.multi_phone_numbers && lead.multi_phone_numbers.length > 0
            ? lead.multi_phone_numbers.map(p => ({ label: p.label || '', number: p.number || '' }))
            : [{ label: '', number: '' }]
    );
    ...
    return (
        <AppLayout>
            <Head title={`Edit Lead - ${lead.first_name} ${lead.last_name}`} />
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex gap-2">
                                <Link href={route('leads.show', lead.id)}>
                                    <Button variant="secondary" size="sm">View Lead</Button>
                                </Link>
