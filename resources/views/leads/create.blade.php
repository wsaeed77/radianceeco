                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('address_line_1') is-invalid @enderror" id="address_line_1" name="address_line_1" value="{{ old('address_line_1') }}">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select @error('stage') is-invalid @enderror" id="stage" name="stage" required>
                                                    ...
                                                    @foreach($stages as $team)
                                                        <option value="{{ $team->value }}" {{ old('stage') == $team->value ? 'selected' : '' }}>
                                                            {{ $team->label() }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('source') is-invalid @enderror" id="source" name="source">
                                                ...
                                                @foreach(\App\Enums\LeadSource::cases() as $source)
                                                    <option value="{{ $source->value }}" {{ old('source') == $source->value ? 'selected' : '' }}>{{ $source->value }}</option>
                                                @endforeach
                                            </select>
                                            @error('source')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('source_details') is-invalid @enderror" id="source_details" name="source_details" value="{{ old('source_details') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('grant_type') is-invalid @enderror" id="grant_type" name="grant_type">
                                                ...
                                                <option value="GBIS" {{ old('grant_type') == 'GBIS' ? 'selected' : '' }}>GBIS</option>
                                                <option value="ECO4" {{ old('grant_type') == 'ECO4' ? 'selected' : '' }}>ECO4</option>
                                            </select>
                                            @error('grant_type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control @error('benefit_holder_name') is-invalid @enderror" id="benefit_holder_name" name="benefit_holder_name" value="{{ old('benefit_holder_name') }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control @error('benefit_holder_dob') is-invalid @enderror" id="benefit_holder_dob" name="benefit_holder_dob" value="{{ old('benefit_holder_dob') }}">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select @error('data_match_status') is-invalid @enderror" id="data_match_status" name="data_match_status">
                                                <option value="">Select Status</option>
                                                <option value="Pending" {{ old('data_match_status') == 'Pending' ? 'selected' : '' }}>Pending</option>
                                                <option value="Sent" {{ old('data_match_status') == 'Sent' ? 'selected' : '' }}>Sent</option>
                                                <option value="Matched" {{ old('data_match_status') == 'Matched' ? 'selected' : '' }}>Matched</option>
                                                <option value="Unmatched" {{ old('data_match_status') == 'Unmatched' ? 'selected' : '' }}>Unmatched</option>
                                                <option value="Unverified" {{ old('data_match_status') == 'Unverified' ? 'selected' : '' }}>Unverified</option>
                                            </select>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control @error('data_match_remarks') is-invalid @enderror" id="data_match_remarks" name="data_match_remarks" rows="3">{{ old('data_match_remarks') }}</textarea>
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control @error('eligibility_client_dob') is-invalid @enderror" id="eligibility_client_dob" name="eligibility_client_dob" value="{{ old('eligibility_client_dob') }}">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select @error('possible_grant_types') is-invalid @enderror" id="possible_grant_types" name="possible_grant_types">
                                                ...
                                                <option value="Loft only" {{ old('possible_grant_types') == 'Loft only' ? 'selected' : '' }}>Loft only</option>
                                                <option value="Loft+TRV+Thermostate" {{ old('possible_grant_types') == 'Loft+TRV+Thermostate' ? 'selected' : '' }}>Loft+TRV+Thermostate</option>
                                                <option value="Boiler" {{ old('possible_grant_types') == 'Boiler' ? 'selected' : '' }}>Boiler</option>
                                                <option value="Boiler+Loft" {{ old('possible_grant_types') == 'Boiler+Loft' ? 'selected' : '' }}>Boiler+Loft</option>
                                            </select>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select @error('benefit_type') is-invalid @enderror" id="benefit_type" name="benefit_type">
                                                ...
                                                <option value="Universal Credit" {{ old('benefit_type') == 'Universal Credit' ? 'selected' : '' }}>Universal Credit</option>
                                                <option value="Child Benefit" {{ old('benefit_type') == 'Child Benefit' ? 'selected' : '' }}>Child Benefit</option>
                                                <option value="Pension Credit" {{ old('benefit_type') == 'Pension Credit' ? 'selected' : '' }}>Pension Credit</option>
                                                <option value="Child Tax Credit" {{ old('benefit_type') == 'Child Tax Credit' ? 'selected' : '' }}>Child Tax Credit</option>
                                                <option value="Income Support" {{ old('benefit_type') == 'Income Support' ? 'selected' : '' }}>Income Support</option>
                                                <option value="Job Seeker Allowance" {{ old('benefit_type') == 'Job Seeker Allowance' ? 'selected' : '' }}>Job Seeker Allowance</option>
                                                <option value="No Benefit" {{ old('benefit_type') == 'No Benefit' ? 'selected' : '' }}>No Benefit</option>
                                            </select>
                                            @error('benefit_type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select @error('council_tax_band') is-invalid @enderror" id="council_tax_band" name="council_tax_band">
                                                ...
                                                <option value="A" {{ old('council_tax_band') == 'A' ? 'selected' : '' }}>Band A</option>
                                                <option value="B" {{ old('council_tax_band') == 'B' ? 'selected' : '' }}>Band B</option>
                                                <option value="C" {{ old('council_tax_band') == 'C' ? 'selected' : '' }}>Band C</option>
                                                <option value="D" {{ old('council_tax_band') == 'D' ? 'selected' : '' }}>Band D</option>
                                                <option value="E" {{ old('council_tax_band') == 'E' ? 'selected' : '' }}>Band E</option>
                                                <option value="F" {{ old('council_tax_band') == 'F' ? 'selected' : '' }}>Band F</option>
                                            </select>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select @error('epc_rating') is-invalid @enderror" id="epc_rating" name="epc_rating">
                                                ...
                                                <option value="E" {{ old('epc_rating') == 'E' ? 'selected' : '' }}>E</option>
                                                <option value="F" {{ old('epc_rating') == 'F' ? 'selected' : '' }}>F</option>
                                            </select>
                                            @error('epc_rating')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control @error('gas_safe_info') is-invalid @enderror" id="gas_safe_info" name="gas_safe_info" value="{{ old('gas_safe_info') }}">
                                            @error('gas_safe_info')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control @error('poa_info') is-invalid @enderror" id="poa_info" name="poa_info" value="{{ old('poa_info') }}">
                                            @error('poa_info')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <textarea class="form-control @error('epc_details') is-invalid @enderror" id="epc_details" name="epc_details" rows="3">{{ old('epc_details') }}</textarea>
                                            @error('epc_details')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
